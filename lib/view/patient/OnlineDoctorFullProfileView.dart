...
import 'package:maulaji/networking/Const.dart';
import 'package:maulaji/networking/indFileOne.dart';
import 'package:maulaji/projPaypal/PaypalPayment.dart';
import 'package:maulaji/projPaypal/config.dart';
import 'package:maulaji/projPaypal/makePayment.dart';
...
class HomePageState extends State<OnlineDoctorFullProfileView> {
  ...
  Future<String> getData() async {
    ...
    final http.Response response = await http.post(
      "https://api.callgpnow.com/api/" + 'doctor-education-chamber-info',
  ...
  Future<String> getSubscriptions() async {
    ...
    final http.Response response = await http.post(
      "https://api.callgpnow.com/api/" + 'check_subscriptions',
      headers: <String, String>{
        'Content-Type': 'application/json; charset=UTF-8',
  ...
  Future<String> getPaymentMethods() async {
    ...
    final http.Response response = await http.get(
      "https://api.callgpnow.com/api/" + 'get_payment_methods_list',
      headers: <String, String>{
        'Content-Type': 'application/json; charset=UTF-8',
        'Authorization': AUTH_KEY,
      },
...
//"https://api.callgpnow.com/" + widget.photo,
//)),
//Center(
//child: Padding(
//padding: EdgeInsets.all(10),
