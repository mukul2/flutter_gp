...
class UrgentRequestActivity extends StatefulWidget {
  ...
  String name,reason,chosenDate,birthdate,hospital,email,phone,address,allergy;
  String docID ;

  UrgentRequestActivity(this.docID);
  @override
  _ChooseDoctorChamberState createState() => _ChooseDoctorChamberState();
}

class _ChooseDoctorChamberState extends State<UrgentRequestActivity> {
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: Text("Urgent Care Booking",style: TextStyle(fontSize: 20,color: Colors.white),),
                    )
                  ],
                ),
              ),
                          ...
                          InkWell(
                            ...
                            onTap: ()async{
                              ...
                              if(_formKey.currentState.validate()){
                                ...
                                UrgentCareRequest(widget.docID,
                                    uid,
                                    widget.reason,
                                   "name",
                                    widget.reason,
                                    ...
                                    widget.address,
                                    widget.dateToUpdate,
                                    "phone",widget.allergy).then((value) {
                                    setState(() {
