...
class GPSearchActivity extends StatefulWidget {
...
class _ChooseDoctorChamberState extends State<GPSearchActivity> {
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: Container(height: 60,child: Center(child: Text("Top Doctors",style: TextStyle(fontSize: 20,color: Colors.white),))),
                    )
                  ],
                ),
              ),
