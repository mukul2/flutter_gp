...
class UrgentSearchActivity extends StatefulWidget {
  ...
  bool _enabled2 = true;
  bool isLoading = true ;
  UrgentSearchActivity();
  @override
  _ChooseDoctorChamberState createState() => _ChooseDoctorChamberState();
}

class _ChooseDoctorChamberState extends State<UrgentSearchActivity> {
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: Text("Urgent Available Doctors",style: TextStyle(fontSize: 20,color: Colors.white),),
                    )
                  ],
                ),
              ),
